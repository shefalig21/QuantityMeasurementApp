...
const Length = () => {
  ...
  const convertLength = (value, from, to) => {
    ...
    if (from === 'Meters' && to === 'Centimeters') return value * 100;
    if (from === 'Centimeters' && to === 'Meters') return value / 100;
    if (from === 'Kilometers' && to === 'Centimeters') return value * 100000;
    if (from === 'Centimeters' && to === 'Kilometers') return value / 100000;
    return value;
  };
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.title}>Length Conversion</Text>
        <TextInput
          style={styles.input}
